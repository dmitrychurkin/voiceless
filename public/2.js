...
/* harmony import */ var _hooks_useStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../hooks/useStore */ "./resources/js/module/admin/hooks/useStore.js");
...
var Dashboard = function Dashboard() {
  ...
  var _useStore = Object(_hooks_useStore__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      state = _useStore.state;

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      _useState2 = _slicedToArray(_useState, 2),
      queuedRoute = _useState2[0],
      setQueuedRoute = _useState2[1];
  ...
  var checkCanActivate = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function () {
    return state.router.canActivate;
  }, [state.router.canActivate]);
  var navigateTo = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (to, options) {
    navigate(to, options);
    setQueuedRoute();
  }, [navigate]);
  ...
  }, [checkCanActivate, navigateTo]);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (state.router.canActivate && queuedRoute) {
      navigateTo(queuedRoute);
    }
  }, [state.router.canActivate, queuedRoute, navigateTo]);
