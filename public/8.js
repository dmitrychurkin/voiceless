...
var validationSchema = yup__WEBPACK_IMPORTED_MODULE_4__["object"](_defineProperty({}, formSchema.email, yup__WEBPACK_IMPORTED_MODULE_4__["string"]('Enter your email').email('Enter a valid email').required('Email is required')));
...
var PasswordForgot = function PasswordForgot() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('/admin/forgot-password', values);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_templates_Auth__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_5__["default"], (_React$createElement = {
      type: "email",
      variant: "outlined",
      margin: "normal",
      required: true,
